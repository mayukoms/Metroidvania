...
AnimatedSprite::AnimatedSprite(SDL_Texture* texture, int source_x, int source_y, int width, int height, int fps, int num_frames) :
	Sprite(texture, source_x, source_y, width, height),
